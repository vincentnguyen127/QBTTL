...
Public Class TLVendor
    ...
    Public Sub GetAndAddEmployeeInTimeLive()
        ...
        Try
            ...
            Dim pblenth As Integer = vendorRetListCount - 1
            If pblenth >= 0 Then
    ...
    Private Sub btnAddVendorInTimeLive_Click(sender As System.Object, e As System.EventArgs) Handles btnAddVendorInTimeLive.Click
        pgbar.Value = 0
        Try
    ...
    Private Sub TLVendor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
